...
const Trusted_dealers = () => {

    const [pendingPaymentsCount, setPendingPaymentsCount] = useState(5);
    const [outstandingCustomersCount, setOutstandingCustomersCount] = useState(12);
    const [overLimitCustomersCount, setOverLimitCustomersCount] = useState(3);
    ...
    const loadDashboardCards = async () => {
        try {
            ...
            const outstanding =
                await api.get(
                    "/admin/outstanding-customers-count"
                );

            const overLimit =
                await api.get(
                    "/admin/over-limit-customers-count"
                );
            ...
            setOutstandingCustomersCount(
                outstanding.data.count
            );

            setOverLimitCustomersCount(
                overLimit.data.count
            );
    ...
    ===================================================== */}
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-yellow-500 transition p-5">
                    ...
                    <button
                        onClick={() => navigate('/pending-credit-payments')}
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-yellow-500 transition p-5">
                    ...
                    <button
                        onClick={() => navigate('/outstanding-customers')}
                        className="mt-4 inline-flex items-center gap-1
                        text-sm font-semibold
                        text-black hover:text-yellow-600
                        transition"
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-yellow-500 transition p-5">
                    ...
                    <button
                        onClick={() => navigate('/over-limit-customers')}
                        className="mt-4 inline-flex items-center gap-1
                        text-sm font-semibold
                        text-black hover:text-yellow-600
                        transition"
...
export default Trusted_dealers;
