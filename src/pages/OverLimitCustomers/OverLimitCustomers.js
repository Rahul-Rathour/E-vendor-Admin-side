...
const OverLimitCustomers = () => {
  ...
  // ==============================
  // FETCH OVER LIMIT CUSTOMERS
  // ==============================
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const response = await api.get(
          "admin/over-limit-customers"
        );
        ...
        toast.error("Failed to load over limit customers");
      }
    };
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-1 text-sm">
                  Customers whose outstanding amount has reached their credit limit.
                </p>
            ...
            <table className="min-w-[900px] w-full">
              ...
              <thead className="bg-black">
                ...
                <tr>
                  ...
                  <th className="px-5 py-4 text-center text-xs font-semibold text-yellow-400 uppercase">
                    Status
                  </th>
...
export default OverLimitCustomers;